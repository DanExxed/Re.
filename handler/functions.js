...
async function swap_pages2(client, interaction, embeds) {
  ...
  let button_back = new MessageButton().setStyle('SECONDARY').setCustomId('1').setEmoji("<:a_back:1043491529408397312>").setLabel("Back")

  let button_forward = new MessageButton().setStyle('SECONDARY').setCustomId('3').setEmoji('<:a_play:1015813755453575218>').setLabel("Next")
