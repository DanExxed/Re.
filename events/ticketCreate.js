...
client.on("interactionCreate", async(interaction) => {
  ...
  if (interaction.customId == `create_ticket${s}`) {
      ...
      db1.findOne({
          ...
          interaction.reply({
              content: `<a:a_loading:1019257415176290415> **Creating your ticket...** _could take a few seconds._`,
              ephemeral: true
          })



          interaction.guild.channels.create(`${data.Style||`
                  ...
                  if (data_) {
                      ...
                      db1.findOne({
                          ...
                          const embed = new MessageEmbed()
                              ...
                              .setFooter(`${client.user.username} | Simple tickets for your server!`, client.user.displayAvatarURL())
                          ...
                          channel.send({
                              content: `Welcome, <@${interaction.user.id}> to your ticket - <@&${data.Admin}>`,
                              embeds: [embed],
                              components: [row]
                          })
  ...
  if (interaction.customId == `tc_archive${s}`) {
      ...
      db.findOne({
          ...
          if (!opener) return interaction.reply({
              content: `${client.emoji.wrong} User isnt found in this server!`,
              ephemeral: true
          })
          ...
          db1.findOne({
              ...
              const embed = new MessageEmbed()
                  .setColor(`DARK_GREEN`)
                  .setAuthor(`${interaction.user.tag} - Archived Ticket`, interaction.user.displayAvatarURL())
                  .addField(`**Ticket Opener:**`, `<@${opener.id}> | \`${opener.id}\` / *\`${opener.tag}\`*`)
  ...
  if (interaction.customId == `tc_unarchive${s}`) {
      ...
      db.findOne({
          ...
          db1.findOne({
              ...
              const embed = new MessageEmbed()
                  .setColor(`DARK_GREEN`)
                  .setAuthor(`${interaction.user.tag} - Un-Archived Ticket`, interaction.user.displayAvatarURL())
                  .addField(`**Ticket Opener:**`, `<@${opener.id}> | \`${opener.id}\` / *\`${opener.tag}\`*`)
